...
def get_config():
    ...
    sampling.fista_max_iter = (
        300  # Maximum FISTA iterations (increased for better convergence)
    )
    sampling.tv_prox_steps = (
        50  # TV proximal operator steps (based on CCPi without warm start)
    )
